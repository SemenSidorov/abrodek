...
<section class="slide_pages1">
    <div class="container">
        <div class="title title-pages">Области применения <br /><span>большепролетных конструкций из клееной древесины:</span></div>
        <?$GLOBALS["arrFilter"] = ["IBLOCK_SECTION_ID" => $arResult["IBLOCK_SECTION_ID"]];?>
        ...
        <?/*$APPLICATION->IncludeComponent(
        	...
        	Array(
        		...
        		"SECTION_ID" => $arResult["SECTION_PARENT_ID"],
        		"SECTION_URL" => "",
        		"SECTION_USER_FIELDS" => array("",""),
        		"SHOW_PARENT_NAME" => "Y",
        		"TOP_DEPTH" => "2",
        		"VIEW_MODE" => "LINE",
            "ACTIVE_SECTION_ID" => $arResult["IBLOCK_SECTION_ID"]
        	)
        );*/?>
