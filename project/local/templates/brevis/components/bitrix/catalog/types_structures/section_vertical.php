...
/*
$isTopSections = false;
$sections = CIBlockSection::GetList(array(), array("SECTION_ID" => false), false, array(), false);
while($section = $sections->Fetch()){
		if($section["ID"] == $arResult["VARIABLES"]["SECTION_ID"] || $section["CODE"] == $arResult["VARIABLES"]["SECTION_CODE"]){
				$isTopSections = true;
				break;
		}
}
